...
var types = []any{
	...
	new(func(any, any) decimal.Decimal),
	...
	new(func(decimal.Decimal, int8) decimal.Decimal),
	new(func(decimal.Decimal, int16) decimal.Decimal),
	new(func(decimal.Decimal, int32) decimal.Decimal),
	new(func(decimal.Decimal, int) decimal.Decimal),
	new(func(decimal.Decimal, int64) decimal.Decimal),
	new(func(decimal.Decimal, float32) decimal.Decimal),
	new(func(decimal.Decimal, float64) decimal.Decimal),
	...
	new(func(int, int) decimal.Decimal),
	new(func(int, int) string),
	new(func(int16) decimal.Decimal),
